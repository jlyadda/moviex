            ...
            <View>
              <Image
                source={{
                  uri:
                    ticket.image ||
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0XC4uUvKYqPQOokhi2SisI2b-FvOU4-KG8g&s",
                }}
              ...
              <View
                style={{
                  position: "absolute",
                  top: -40,
                  left: -40, // backgroundColor: '#1a1a1a',
                  backgroundColor: "#fff",
                  width: 80,
                  height: 80,
                  borderRadius: 80,
              ...
              <View
                style={{
                  position: "absolute",
                  top: -40,
                  right: -40, // backgroundColor: '#1a1a1a',
                  backgroundColor: "#fff",
                  width: 80,
                  height: 80,
                  borderRadius: 80,
              ...
              <View style={styles.seatsContainer}>
                ...
                {ticket.total ? (
                  <Text style={styles.totalText}>
                    UGX {Number(ticket.total).toLocaleString()}
                  </Text>
                ) : null}
              </View>
