        ...
        <Animated.View entering={FadeIn.duration(500)} style={styles.content}>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryGrid}>
              <View style={styles.summaryLeft}>
                <Ticket size={18} color="#0a7ea4" />
                <View style={{ marginLeft: 10 }}>
                  <Text style={styles.summaryLabel}>
                    Ticket{seats && Number(seats) > 1 ? "s" : ""}
                  </Text>
              ...
              <View style={styles.summaryRight}>
                ...
                <Text style={styles.summaryValue}>
                  UGX{" "}
                  {(
                    Number(total || 0) - Number(snacksTotal || 0)
                  ).toLocaleString()}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.summaryGrid}>
              ...
              <View style={styles.summaryRight}>
                ...
                <Text style={styles.summaryValue}>
                  UGX {Number(snacksTotal || 0).toLocaleString()}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.totalValue}>
                UGX {Number(total || 0).toLocaleString()}
              </Text>
            </View>
          </View>
            ...
            <View
              style={[
                ...
                selectedPayment === "card" &&
                  styles.paymentIconContainerSelected,
              ]}
            >
              <CreditCard
                size={24}
                color={selectedPayment === "card" ? "#fff" : "#0a7ea4"}
              />
            </View>
          ...
          >
            ...
            >
              <Wallet
                size={24}
                color={selectedPayment === "momo" ? "#fff" : "#0a7ea4"}
              />
            </View>
            <View style={styles.paymentOptionText}>
